...
const AdminDashboard = () => {
    ...
    return (
      <AdminLayout title="Admin Dashboard" subtitle="Authentication Required">
        <div className="text-center py-12">
          ...
          <p className="text-text-primary opacity-70 mb-4">Please log in to access the admin dashboard.</p>
          <Link
            to="/login"
    ...
    return (
      <AdminLayout title="Access Denied" subtitle="Insufficient Permissions">
        <div className="text-center py-12">
          ...
          <p className="text-text-primary opacity-70 mb-4">You don't have permission to access the admin dashboard.</p>
          <Link
            to="/"
            className="bg-primary-teal text-white px-6 py-2 rounded-md hover:bg-secondary-teal"
          >
      ...
      <AdminLayout title="Error" subtitle="Failed to load dashboard">
        <div className="text-center py-12">
          ...
          <button
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-primary-teal hover:bg-secondary-teal"
          >
            Try Again
          </button>
        </div>
  ...
  return (
    ...
    >
        ...
        <>
          ...
          <div className="mb-6">
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-primary-teal hover:bg-secondary-teal focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-teal"
            >
          ...
          {/* Products Table */}
          <div className="bg-primary-bg shadow-sm rounded-lg overflow-hidden">
            <div className="px-6 py-4 border-b border-secondary-bg">
              <h2 className="text-lg font-medium text-text-primary">All Products</h2>
            </div>
            ...
            {products.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-text-primary opacity-70 mb-4">Get started by creating your first product.</p>
                <button
                  onClick={() => setViewMode('create')}
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-primary-teal hover:bg-secondary-teal"
                >
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-primary-bg divide-y divide-secondary-bg">
                    {products.map((product) => (
                      <tr key={product.id} className="hover:bg-secondary-bg">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            <div className="text-sm font-medium text-text-primary">
                              {product.name}
                            </div>
                            <div className="text-sm text-text-primary opacity-60 truncate max-w-xs">
                              {product.description}
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-secondary-bg text-primary-teal border border-primary-teal">
                            {product.license}
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-text-primary opacity-60">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <div className="flex justify-end space-x-2">
                            <button
                              ...
                              className="text-primary-teal hover:text-secondary-teal"
                            >
                              Edit
                            </button>
                            <button
      ...
      {viewMode === 'create' && (
        <div className="bg-primary-bg shadow-sm rounded-lg overflow-hidden h-full flex flex-col">
          <div className="px-6 py-4 border-b border-secondary-bg bg-secondary-bg flex-shrink-0">
            <h2 className="text-xl font-semibold text-text-primary">Create New Product</h2>
          </div>
